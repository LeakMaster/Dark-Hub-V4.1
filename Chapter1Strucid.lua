...
LPTab:Toggle('Godmode',function(state)
...
if game.PlaceId == 10705886260 and Services.LocalPlayer.PlayerGui.MenuGUI.RoundInfoFrame.RoundType.Text == "FFA" or  game.PlaceId == 10726543104 then
    ...
    local RayCast = getsenv(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.MainLocal).RayCast
      getsenv(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.MainLocal).RayCast = function(Argument_1, Argument_2, Argument_3, Argument_4, Argument_5, ...)
        ...
        if Argument_1 ~= game:GetService("Players").LocalPlayer.Character.Head.Position then
          local RayHit, RayPosition = game:GetService("Workspace").FindPartOnRayWithIgnoreList(game:GetService("Workspace"), Ray.new(Argument_1, (Argument_2 - Argument_1).unit * 9007199300000000), Argument_3)
